...
// GetTagRequest is the request body for POST /hub/get-tag.
...
// FilterTagsRequest is the request body for POST /hub/filter-tags.
...
// FilterTagsResponse is the response for POST /hub/filter-tags.

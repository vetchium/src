...
A Tag will be having an unique human-readable ID in English. Ex: artificial-intelligence. It should all be in lowercase and contain only English lower case letters and a hyphen.

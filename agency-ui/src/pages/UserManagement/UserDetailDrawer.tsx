...
import type { AgencyUser } from "vetchium-specs/agency/agency-users";
import type {
	AssignRoleRequest,
	RemoveRoleRequest,
...
export function UserDetailDrawer({
	...
	const handleAssignRole = async () => {
		...
		try {
			...
			const response = await fetch(`${apiBaseUrl}/agency/assign-role`, {
				method: "POST",
				headers: {
	...
	const handleRemoveRole = async (roleName: string) => {
		...
		try {
			...
			const response = await fetch(`${apiBaseUrl}/agency/remove-role`, {
				method: "POST",
				headers: {
					"Content-Type": "application/json",
					Authorization: `Bearer ${sessionToken}`,

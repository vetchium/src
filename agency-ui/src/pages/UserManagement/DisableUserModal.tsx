...
import type { AgencyDisableUserRequest } from "vetchium-specs/agency/agency-users";
...
export function DisableUserModal({
	...
	const handleDisable = async () => {
		...
		if (myInfo?.agency_user_id === email) {
		...
		try {
			...
			const request: AgencyDisableUserRequest = {
				email_address: email,
			};

			const response = await fetch(`${apiBaseUrl}/agency/disable-user`, {
				method: "POST",
				headers: {

...
export function ForgotPasswordPage() {
    ...
    const onFinish = async (values: { email: string; domain: string }) => {
        ...
        try {
            ...
            const response = await fetch(`${apiBaseUrl}/employer/request-password-reset`, {
                method: "POST",
        ...
        return (
            <Card style={{ width: 400, boxShadow: "0 4px 12px rgba(0,0,0,0.1)" }}>
                <div style={{ textAlign: "center" }}>
                    ...
                    <Text>
                        If an account exists for that email in the specified domain, we have sent password reset
                        instructions.
                    </Text>

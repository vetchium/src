...
func InviteUser(s *server.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// Check if user has permission to invite users (must be admin for now)
		// TODO: Check for invite_users role when RBAC is implemented
		if !agencyUser.IsAdmin {
			log.Debug("user does not have permission to invite users", "org_user_id", agencyUser.AgencyUserID)
		...
		globalUser, err := s.Global.CreateAgencyUser(ctx, globaldb.CreateAgencyUserParams{
			...
			PreferredLanguage: agencyUser.PreferredLanguage, // Inherit from inviter

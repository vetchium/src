...
const nsAgencySignup = "emails/agency_signup"

// AgencySignupData contains data for the agency signup DNS verification email
type AgencySignupData struct {
...
// AgencySignupSubject returns the localized email subject for agency signup
func AgencySignupSubject(lang string) string {
	return i18n.T(lang, nsAgencySignup, "subject")
}

// AgencySignupTextBody returns the localized plain text body for agency signup email
func AgencySignupTextBody(lang string, data AgencySignupData) string {
	portalName := i18n.T(lang, nsAgencySignup, "portal_name")
	intro := i18n.T(lang, nsAgencySignup, "body_intro")
	separateEmailNote := i18n.T(lang, nsAgencySignup, "body_separate_email_note")
	dnsInstructions := i18n.TF(lang, nsAgencySignup, "body_dns_instructions", data)
	step1 := i18n.T(lang, nsAgencySignup, "step1")
	step2 := i18n.T(lang, nsAgencySignup, "step2")
	step3 := i18n.T(lang, nsAgencySignup, "step3")
	step4 := i18n.T(lang, nsAgencySignup, "step4")
	step5 := i18n.T(lang, nsAgencySignup, "step5")
	recordTypeLabel := i18n.T(lang, nsAgencySignup, "record_type_label")
	hostLabel := i18n.T(lang, nsAgencySignup, "host_label")
	valueLabel := i18n.T(lang, nsAgencySignup, "value_label")
	ttlLabel := i18n.T(lang, nsAgencySignup, "ttl_label")
	propagationNote := i18n.T(lang, nsAgencySignup, "propagation_note")
	expiry := i18n.TF(lang, nsAgencySignup, "body_expiry", data)
	ignore := i18n.T(lang, nsAgencySignup, "body_ignore")
	footer := i18n.T(lang, nsAgencySignup, "footer")
...
// AgencySignupHTMLBody returns the localized HTML body for agency signup email
func AgencySignupHTMLBody(lang string, data AgencySignupData) string {
	escapedDNSValue := html.EscapeString(data.DNSRecordValue)
	escapedDomain := html.EscapeString(data.Domain)
	portalName := html.EscapeString(i18n.T(lang, nsAgencySignup, "portal_name"))
	intro := html.EscapeString(i18n.T(lang, nsAgencySignup, "body_intro"))
	separateEmailNote := html.EscapeString(i18n.T(lang, nsAgencySignup, "body_separate_email_note"))
	dnsInstructions := html.EscapeString(i18n.TF(lang, nsAgencySignup, "body_dns_instructions", data))
	step1 := html.EscapeString(i18n.T(lang, nsAgencySignup, "step1"))
	step2 := html.EscapeString(i18n.T(lang, nsAgencySignup, "step2"))
	step3 := html.EscapeString(i18n.T(lang, nsAgencySignup, "step3"))
	step4 := html.EscapeString(i18n.T(lang, nsAgencySignup, "step4"))
	step5 := html.EscapeString(i18n.T(lang, nsAgencySignup, "step5"))
	recordTypeLabel := html.EscapeString(i18n.T(lang, nsAgencySignup, "record_type_label"))
	hostLabel := html.EscapeString(i18n.T(lang, nsAgencySignup, "host_label"))
	valueLabel := html.EscapeString(i18n.T(lang, nsAgencySignup, "value_label"))
	ttlLabel := html.EscapeString(i18n.T(lang, nsAgencySignup, "ttl_label"))
	propagationNote := html.EscapeString(i18n.T(lang, nsAgencySignup, "propagation_note"))
	expiry := html.EscapeString(i18n.TF(lang, nsAgencySignup, "body_expiry", data))
	ignore := html.EscapeString(i18n.T(lang, nsAgencySignup, "body_ignore"))
	footer := html.EscapeString(i18n.T(lang, nsAgencySignup, "footer"))

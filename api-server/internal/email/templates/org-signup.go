...
func OrgSignupTextBody(lang string, data OrgSignupData) string {
	...
	step3 := i18n.T(lang, nsOrgSignup, "step3")
	step4 := i18n.T(lang, nsOrgSignup, "step4")
	step5 := i18n.T(lang, nsOrgSignup, "step5")
	recordTypeLabel := i18n.T(lang, nsOrgSignup, "record_type_label")
	hostLabel := i18n.T(lang, nsOrgSignup, "host_label")
	valueLabel := i18n.T(lang, nsOrgSignup, "value_label")
	ttlLabel := i18n.T(lang, nsOrgSignup, "ttl_label")
	propagationNote := i18n.T(lang, nsOrgSignup, "propagation_note")
...
func OrgSignupHTMLBody(lang string, data OrgSignupData) string {
	...
	step3 := html.EscapeString(i18n.T(lang, nsOrgSignup, "step3"))
	step4 := html.EscapeString(i18n.T(lang, nsOrgSignup, "step4"))
	step5 := html.EscapeString(i18n.T(lang, nsOrgSignup, "step5"))
	recordTypeLabel := html.EscapeString(i18n.T(lang, nsOrgSignup, "record_type_label"))
	hostLabel := html.EscapeString(i18n.T(lang, nsOrgSignup, "host_label"))
	valueLabel := html.EscapeString(i18n.T(lang, nsOrgSignup, "value_label"))
	ttlLabel := html.EscapeString(i18n.T(lang, nsOrgSignup, "ttl_label"))
	propagationNote := html.EscapeString(i18n.T(lang, nsOrgSignup, "propagation_note"))

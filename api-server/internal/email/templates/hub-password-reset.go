...
const nsHubPasswordReset = "emails/hub_password_reset"

// HubPasswordResetData contains data for the hub password reset email
...
func HubPasswordResetSubject(lang string) string {
	return i18n.T(lang, nsHubPasswordReset, "subject")
}

// HubPasswordResetTextBody returns the localized plain text body for hub password reset email
func HubPasswordResetTextBody(lang string, data HubPasswordResetData) string {
	...
	footer := i18n.T(lang, nsHubPasswordReset, "footer")
...
// HubPasswordResetHTMLBody returns the localized HTML body for hub password reset email
func HubPasswordResetHTMLBody(lang string, data HubPasswordResetData) string {
	...
	ignore := html.EscapeString(i18n.T(lang, nsHubPasswordReset, "body_ignore"))
	footer := html.EscapeString(i18n.T(lang, nsHubPasswordReset, "footer"))

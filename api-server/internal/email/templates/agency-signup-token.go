...
const nsAgencySignupToken = "emails/agency_signup_token"

// AgencySignupTokenData contains data for the agency signup token email (private, not to be forwarded)
type AgencySignupTokenData struct {
...
// AgencySignupTokenSubject returns the localized email subject for agency signup token email
func AgencySignupTokenSubject(lang string) string {
	return i18n.T(lang, nsAgencySignupToken, "subject")
}

// AgencySignupTokenTextBody returns the localized plain text body for agency signup token email
func AgencySignupTokenTextBody(lang string, data AgencySignupTokenData) string {
	portalName := i18n.T(lang, nsAgencySignupToken, "portal_name")
	warning := i18n.T(lang, nsAgencySignupToken, "warning_do_not_forward")
	intro := i18n.TF(lang, nsAgencySignupToken, "body_intro", data)
	dnsNote := i18n.T(lang, nsAgencySignupToken, "body_dns_note")
	clickHere := i18n.T(lang, nsAgencySignupToken, "body_click_here")
	orUseToken := i18n.T(lang, nsAgencySignupToken, "body_or_use_token")
	expiry := i18n.TF(lang, nsAgencySignupToken, "body_expiry", data)
	ignore := i18n.T(lang, nsAgencySignupToken, "body_ignore")
	footer := i18n.T(lang, nsAgencySignupToken, "footer")
...
// AgencySignupTokenHTMLBody returns the localized HTML body for agency signup token email
func AgencySignupTokenHTMLBody(lang string, data AgencySignupTokenData) string {
	...
	portalName := html.EscapeString(i18n.T(lang, nsAgencySignupToken, "portal_name"))
	warning := html.EscapeString(i18n.T(lang, nsAgencySignupToken, "warning_do_not_forward"))
	intro := html.EscapeString(i18n.TF(lang, nsAgencySignupToken, "body_intro", data))
	dnsNote := html.EscapeString(i18n.T(lang, nsAgencySignupToken, "body_dns_note"))
	buttonText := html.EscapeString(i18n.T(lang, nsAgencySignupToken, "button_text"))
	orUseToken := html.EscapeString(i18n.T(lang, nsAgencySignupToken, "body_or_use_token"))
	expiry := html.EscapeString(i18n.TF(lang, nsAgencySignupToken, "body_expiry", data))
	ignore := html.EscapeString(i18n.T(lang, nsAgencySignupToken, "body_ignore"))
	footer := html.EscapeString(i18n.T(lang, nsAgencySignupToken, "footer"))
...
<head>
    ...
    <title>Complete Your Agency Signup</title>
</head>

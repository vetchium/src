...
const nsOrgSignupToken = "emails/org_signup_token"

// OrgSignupTokenData contains data for the org signup token email (private, not to be forwarded)
type OrgSignupTokenData struct {
...
// OrgSignupTokenSubject returns the localized email subject for org signup token email
func OrgSignupTokenSubject(lang string) string {
	return i18n.T(lang, nsOrgSignupToken, "subject")
}

// OrgSignupTokenTextBody returns the localized plain text body for org signup token email
func OrgSignupTokenTextBody(lang string, data OrgSignupTokenData) string {
	portalName := i18n.T(lang, nsOrgSignupToken, "portal_name")
	warning := i18n.T(lang, nsOrgSignupToken, "warning_do_not_forward")
	intro := i18n.TF(lang, nsOrgSignupToken, "body_intro", data)
	dnsNote := i18n.T(lang, nsOrgSignupToken, "body_dns_note")
	clickHere := i18n.T(lang, nsOrgSignupToken, "body_click_here")
	orUseToken := i18n.T(lang, nsOrgSignupToken, "body_or_use_token")
	expiry := i18n.TF(lang, nsOrgSignupToken, "body_expiry", data)
	ignore := i18n.T(lang, nsOrgSignupToken, "body_ignore")
	footer := i18n.T(lang, nsOrgSignupToken, "footer")
...
// OrgSignupTokenHTMLBody returns the localized HTML body for org signup token email
func OrgSignupTokenHTMLBody(lang string, data OrgSignupTokenData) string {
	...
	portalName := html.EscapeString(i18n.T(lang, nsOrgSignupToken, "portal_name"))
	warning := html.EscapeString(i18n.T(lang, nsOrgSignupToken, "warning_do_not_forward"))
	intro := html.EscapeString(i18n.TF(lang, nsOrgSignupToken, "body_intro", data))
	dnsNote := html.EscapeString(i18n.T(lang, nsOrgSignupToken, "body_dns_note"))
	buttonText := html.EscapeString(i18n.T(lang, nsOrgSignupToken, "button_text"))
	orUseToken := html.EscapeString(i18n.T(lang, nsOrgSignupToken, "body_or_use_token"))
	expiry := html.EscapeString(i18n.TF(lang, nsOrgSignupToken, "body_expiry", data))
	ignore := html.EscapeString(i18n.T(lang, nsOrgSignupToken, "body_ignore"))
	footer := html.EscapeString(i18n.T(lang, nsOrgSignupToken, "footer"))
...
<head>
    ...
    <title>Complete Your Org Signup</title>
</head>

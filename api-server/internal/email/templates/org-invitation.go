...
const nsOrgInvitation = "emails/org_invitation"

// OrgInvitationData contains data for the org user invitation email
...
func OrgInvitationSubject(lang string, data OrgInvitationData) string {
	return i18n.TF(lang, nsOrgInvitation, "subject", data)
}

// OrgInvitationTextBody returns the localized plain text body for org invitation email
func OrgInvitationTextBody(lang string, data OrgInvitationData) string {
	...
	footer := i18n.T(lang, nsOrgInvitation, "footer")
...
// OrgInvitationHTMLBody returns the localized HTML body for org invitation email
func OrgInvitationHTMLBody(lang string, data OrgInvitationData) string {
	...
	security := html.EscapeString(i18n.T(lang, nsOrgInvitation, "body_security"))
	footer := html.EscapeString(i18n.T(lang, nsOrgInvitation, "footer"))

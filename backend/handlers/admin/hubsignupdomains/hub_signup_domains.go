...
func ListHubSignupDomains(s *adminruntime.Server) http.HandlerFunc {
...
func CreateHubSignupDomain(s *adminruntime.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func UpdateHubSignupDomain(s *adminruntime.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		identity, ok := middleware.AdminIdentityFromContext(r.Context())
		if !ok {
			s.AuthenticationProblem(

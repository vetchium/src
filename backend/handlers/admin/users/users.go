...
func ListUsers(s *adminruntime.Server) http.HandlerFunc {
...
func DisableUser(s *adminruntime.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func EnableUser(s *adminruntime.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func writeAdminUserMutationProblem(
	s *adminruntime.Server, w http.ResponseWriter, r *http.Request,
	result string,
) bool {
	switch result {
	case "not_found":
...
func applyAdminUsersPaginationKey(
	s *adminruntime.Server, params *sqlc.ListAdminUsersParams,

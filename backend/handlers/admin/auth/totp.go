...
var adminTOTPProblems = handlerauth.TOTPProblems{
	...
	LoginChallenge:        adminauthn.LoginTokenChallenge,
	BearerChallenge:       adminauthn.BearerChallenge,
}
...
func adminSecondFactorLogin(
	s *adminruntime.Server, tokenHash []byte, now time.Time,
...
func VerifyTFA(s *adminruntime.Server) http.HandlerFunc {
...
func VerifyRecoveryCode(s *adminruntime.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func StartTOTPEnrollment(s *adminruntime.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		key, ok := handlerauth.IdempotencyKey(s, w, r)
		if !ok {
			return
...
func ConfirmTOTPEnrollment(s *adminruntime.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func DisableTOTP(s *adminruntime.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		identity, _ := middleware.AdminIdentityFromContext(r.Context())
...
func RegenerateTOTPRecoveryCodes(s *adminruntime.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		key, ok := handlerauth.IdempotencyKey(s, w, r)
		if !ok {
			return

...
func RequestPasswordReset(s *hubruntime.Server) http.HandlerFunc {
...
func CompletePasswordReset(s *hubruntime.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		handlerauth.RunIdempotent(
			...
			func(q *sqlc.Queries) (
				...
				return handlerauth.PasswordReset{
					...
					Challenge:      hubauthn.PasswordResetChallenge,
...
func ChangePassword(s *hubruntime.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {

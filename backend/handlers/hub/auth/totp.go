...
var hubTOTPProblems = handlerauth.TOTPProblems{
	...
	LoginChallenge:        hubauthn.LoginTokenChallenge,
	BearerChallenge:       hubauthn.BearerChallenge,
}
...
func hubSecondFactorLogin(
	s *hubruntime.Server, tokenHash []byte, now time.Time,
...
func VerifyTFA(s *hubruntime.Server) http.HandlerFunc {
...
func VerifyRecoveryCode(s *hubruntime.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func StartTOTPEnrollment(s *hubruntime.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		key, ok := handlerauth.IdempotencyKey(s, w, r)
		if !ok {
			return
...
func ConfirmTOTPEnrollment(s *hubruntime.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func DisableTOTP(s *hubruntime.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		identity, _ := middleware.HubIdentityFromContext(r.Context())
...
func RegenerateTOTPRecoveryCodes(s *hubruntime.Server) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		key, ok := handlerauth.IdempotencyKey(s, w, r)
		if !ok {
			return

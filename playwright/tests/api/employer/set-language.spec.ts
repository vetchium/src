...
import type { OrgSetLanguageRequest } from "vetchium-specs/employer/employer-users";
...
test.describe("Org (Employer) Set Language API", () => {
	...
	let api: EmployerAPIClient;

	test.beforeEach(async ({ request }) => {
		api = new EmployerAPIClient(request);

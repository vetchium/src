...
test.describe("Cost Centers API", () => {
	...
	// Add Cost Center
	// ============================================================================
	test.describe("POST /employer/add-cost-center", () => {
		test("Success: add a cost center (201)", async ({ request }) => {
			...
			try {
				...
				expect(auditEntry.event_data).toHaveProperty("id");
			} finally {
		...
		test("Different employers can have same id (201)", async ({ request }) => {
			const api = new EmployerAPIClient(request);
	...
	// Update Cost Center
	// ============================================================================
	test.describe("POST /employer/update-cost-center", () => {
	...
	// List Cost Centers
	// ============================================================================
	test.describe("POST /employer/list-cost-centers", () => {
		test("Empty list for new employer (200)", async ({ request }) => {
			const api = new EmployerAPIClient(request);

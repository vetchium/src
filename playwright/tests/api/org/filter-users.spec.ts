...
import { createTestOrgUserDirect, deleteTestOrgUser, generateTestOrgEmail } from "../../../lib/db";
...
test.describe("Org Filter Users API", () => {
    ...
    test.beforeAll(async ({ request }) => {
        ...
        const mainUser = await createTestOrgUserDirect(email, TEST_PASSWORD, "ind1", { domain });

...
test.describe("POST /org/login", () => {
	...
	test("login with wrong password returns 401 and records org.login_failed event", async ({
		request,
	}) => {
		const api = new OrgAPIClient(request);
		...
		try {
			...
			// Verify org.login_failed audit log was recorded

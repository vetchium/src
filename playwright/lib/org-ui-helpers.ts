 ...
 */
export async function orgLogin(page: Page, domain: string, email: string, password: string) {
    await page.goto(`${ORG_UI_URL}/login`);
    await page.fill('input[placeholder="Company Domain (e.g., acme.com)"]', domain);

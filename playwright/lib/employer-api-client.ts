 ...
 */
export class EmployerAPIClient {
	constructor(private request: APIRequestContext) {}

	/**
	 * POST /employer/init-signup
	 * Requests signup verification email
	 */
	async initSignup(
		request: OrgInitSignupRequest
	): Promise<APIResponse<OrgInitSignupResponse>> {
		const response = await this.request.post("/employer/init-signup", {
			data: request,
		});
	...
	/**
	 * POST /employer/init-signup with raw body for testing invalid payloads
	 */
	async initSignupRaw(
		body: unknown
	): Promise<APIResponse<OrgInitSignupResponse>> {
	...
	/**
	 * POST /employer/get-signup-details
	...
	async getSignupDetails(
		...
		const response = await this.request.post("/employer/get-signup-details", {
			data: request,
		});
	...
	/**
	 * POST /employer/get-signup-details with raw body for testing invalid payloads
	 */
	...
	async completeSignup(
		...
		const response = await this.request.post("/employer/complete-signup", {
			data: request,
		});
	...
	/**
	 * POST /employer/complete-signup with raw body for testing invalid payloads
	 */
	...
	async claimDomain(
		...
		const response = await this.request.post("/employer/claim-domain", {
			headers: {
	...
	/**
	 * POST /employer/claim-domain with raw body for testing invalid payloads
	 */
	...
	/**
	 * POST /employer/claim-domain without Authorization header (for testing 401)
	 */
	...
	async verifyDomain(
		...
		const response = await this.request.post("/employer/verify-domain", {
			headers: {
				Authorization: `Bearer ${sessionToken}`,
			},
			data: request,
	...
	/**
	 * POST /employer/verify-domain with raw body for testing invalid payloads
	 */
	...
	/**
	 * POST /employer/verify-domain without Authorization header (for testing 401)
	 */
	...
	/**
	 * POST /employer/get-domain-status
	...
	async getDomainStatus(
		...
		const response = await this.request.post("/employer/get-domain-status", {
			headers: {
				Authorization: `Bearer ${sessionToken}`,
			},
			data: request,
	...
	/**
	 * POST /employer/get-domain-status with raw body for testing invalid payloads
	 */
	...
	/**
	 * POST /employer/get-domain-status without Authorization header (for testing 401)
	 */
	...
	async listDomains(
		...
		const response = await this.request.post("/employer/list-domains", {
			headers: {
				Authorization: `Bearer ${sessionToken}`,
			},
			data: request,
	...
	/**
	 * POST /employer/list-domains with raw body for testing invalid payloads
	 */
	...
	/**
	 * POST /employer/list-domains without Authorization header (for testing 401)
	 */
	...
	async filterUsers(
		sessionToken: string,
		request: import("vetchium-specs/employer/employer-users").FilterOrgUsersRequest
	): Promise<
		APIResponse<
			import("vetchium-specs/employer/employer-users").FilterOrgUsersResponse
		>
	> {
		...
		return {
			status: response.status(),
			body: body as import("vetchium-specs/employer/employer-users").FilterOrgUsersResponse,
			errors: Array.isArray(body) ? body : body.errors,
		};
	}
	...
	async setLanguage(
		sessionToken: string,
		request: import("vetchium-specs/employer/employer-users").OrgSetLanguageRequest
	): Promise<APIResponse<{ message: string }>> {
	...
	async getTag(
		...
		const response = await this.request.post("/employer/get-tag", {
			headers: {
				Authorization: `Bearer ${sessionToken}`,
			},
			data: request,
	...
	async filterTags(
		...
		const response = await this.request.post("/employer/filter-tags", {
			headers: {
				Authorization: `Bearer ${sessionToken}`,
			},
			data: request,

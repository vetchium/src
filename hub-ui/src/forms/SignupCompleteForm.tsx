...
export function SignupCompleteForm({ signupToken }: SignupCompleteFormProps) {
  ...
  if (loadingData) {
    return <Alert message={t("common:loading")} type="info" />;
  }

  return (
    <Form form={form} name="signup-complete" onFinish={onFinish} layout="vertical">
      {error && (
      ...
      >
        <Input placeholder={t("signup:displayNamePlaceholder")} size="large" />
      </Form.Item>
